...
def evaluate(csv_path="results/[CLIcK] gpt-4o-mini-2024-07-18.csv"):
    ...
    category_avg.to_csv(f"evals/[CLIcK] eval-{filename}.csv", index=False)
    category_big_avg.to_csv(f"evals/[CLIcK] eval-avg-{filename}.csv", index=False)
